...
const Sort = () => {
  const { filtered_products: products, grid_view, setGridView, seListView, sort, updateSort } = useFilterContext();
  ...
  return (
    <Wrapper>
      <div className="btn-container">
        ...
        <button type='button' className={`${!grid_view ? 'active' : null}`} onClick={seListView}>
          <BsList />
        </button>
      </div>
